...
create table itens_pedido (preco_total decimal(10,2) not null, preco_unit decimal(10,2) not null, quantidade integer not null, id bigint not null auto_increment, pedido_id bigint not null, produto_id bigint not null, observacao varchar(100), primary key (id)) engine=InnoDB;
...
alter table pedidos add constraint UK_t4b08olhbt4sggm7ukl3dp5xj unique (formas_pagamento_id);
