...
public interface RestauranteAtivacaoDocumentation {
    ...
    RestauranteOutput ativo(@ApiParam(value = "ID de um restaurante", example = "1", required = true) Long id);
    ...
    RestauranteOutput inativo(@ApiParam(value = "ID de um restaurante", example = "1", required = true) Long id);
    ...
    RestauranteOutput abertura(@ApiParam(value = "ID de um restaurante", example = "1", required = true) Long id);
    ...
    RestauranteOutput fechamento(@ApiParam(value = "ID de um restaurante", example = "1", required = true) Long id);
