...
public class RestauranteCadastroService {
    ...
    private Restaurante save(Restaurante restaurante) {
        configurarRestaurante(restaurante);
        return restauranteRepository.salvarOuAtualizar(restaurante)
                .orElseThrow();
    }

    private void configurarRestaurante(Restaurante restaurante) {
    ...
    public Restaurante ativar(Long restauranteId) {
        Restaurante restaurante = this.restauranteConsulta.buscarPorId(restauranteId);
        restaurante.ativar();
        return restaurante;
    }
