...
public class RestauranteService {
    ...
    public Restaurante salvarOuAtualizar(Restaurante restaurante) {
        try {
            ...
            if (restaurante.isNovo()) {
                ...
                throw new RestauranteNaoPersistidoException(MSG_RESTAURANTE_NAO_ATUALIZADO);
            }
        }
    }
    ...
    public Restaurante buscarPorId(Long id) {
        try {
            return this.restauranteRepository.buscarPorId(id).orElseThrow();
    ...
    public Restaurante buscarComProdutos(Long id) {
        return this.restauranteRepository.buscarRestauranteComProdutos(id).orElseThrow();
    }
